...
import {
  ...
  type StandingKind,
  type TemplateKind,
} from "../property/kindValues";

// Re-exported: this module was every caller's source for these and still reads as their home, so
// moving the declarations should not ripple through thirty import statements.
export { STANDING_VALUES, isStandingKind };

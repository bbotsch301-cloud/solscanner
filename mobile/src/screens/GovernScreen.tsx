...
const styles = StyleSheet.create({
  ...
  power: { color: "#1A1130", fontSize: 40, fontWeight: "900", letterSpacing: -1 },
  powerUnit: { color: "#1A1130", fontSize: font.h2, fontWeight: "800", marginBottom: spacing(1.5) },
  cardSub: { color: "#1A1130AA", fontSize: font.small, fontWeight: "700" },
